...
const sources = {
    sintelTrailer: 'SampleVideo_1280x720_1mb.mp4',
    bunnyTrailer: 'http://media.w3.org/2010/05/bunny/trailer.mp4',
    bunnyMovie: 'SampleVideo_1280x720_30mb.mp4',
    test: 'SampleVideo_1280x720_30mb.flv'
};
    ...
    render() {
        return (
            <div>
                ...
                <div>State</div>
                <Highlight {...defaultProps} code={this.state.player ? JSON.stringify(this.state.player, null, 2) : JSON.stringify({ "boy": "hello" })} language='json'>
